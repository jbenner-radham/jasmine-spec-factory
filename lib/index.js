...
module.exports = function () {
    ...
    if (!ast.hasPublicMembersDeclaration()) {
        console.error('The AMD module you are parsing does not appear to have a `publicMembers` variable.');
        console.error(`If you believe this to be an error, please report it at: <${pkg.bugs.url}>.`);
        process.exit(1);
    }
