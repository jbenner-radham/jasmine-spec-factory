...
module.exports = function () {
    ...
    try {
        moduleSpecTemplate = fs.readFileSync('./templates/moduleSpec.hbs').toString();
        methodSpecPartial  = fs.readFileSync('./templates/_methodSpec.hbs').toString();
        varSpecPartial     = fs.readFileSync('./templates/_varSpec.hbs').toString();
    } catch (error) {
        console.error(chalk.red(error));
        process.exit(1);
    }
